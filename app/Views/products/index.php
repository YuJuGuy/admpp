...
@media (max-width: 768px) {
        .card-slider-6 {
                display: none; /* Hide slider on phones */
            }

            .categories-grid {
                display: grid; /* Show grid on phones */
            }
        }

@media (min-width: 769px) {
            .category-slick {
                display: block; /* Show slider on PC */
            }

            .categories-grid {
                display: none; /* Hide grid on PC */
            }
        }
    </style>
</head>
